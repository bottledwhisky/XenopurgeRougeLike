...
namespace XenopurgeRougeLike
{
    ...
    public static class WeaponCategories
    {
        ...
        // Shotguns (霰弹枪)
        private static readonly HashSet<string> ShotgunIds = new()
        {
        ...
        // Rifles (步枪)
        private static readonly HashSet<string> RifleIds = new()
        {
        ...
        // Sniper Rifles (狙击枪)
        private static readonly HashSet<string> SniperRifleIds = new()
        {
        ...
        // Daggers (匕首)
        private static readonly HashSet<string> DaggerIds = new()
        {
        ...
        // Blunt Weapons (钝器)
        private static readonly HashSet<string> BluntWeaponIds = new()
        {
        ...
        // Bladed Weapons (剑刃)
        private static readonly HashSet<string> BladeIds = new()
        {
