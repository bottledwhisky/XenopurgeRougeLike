    ...
    public static partial class I18nData
    {
        ...
        private static Dictionary<string, Dictionary<string, string>> GetGunslingerTranslations()
        {
            return new Dictionary<string, Dictionary<string, string>>
            {
                ...
                {
                    ["en"] = "Gain \"Death's Eye\" command, usable once. All friendly units' ranged attacks are guaranteed to hit for {0} <sprite name=\"time icon\">.",
                    ["el"] = "Κερδίστε την εντολή \"Μάτι του Θανάτου\", χρησιμοποιείται μία φορά. Όλες οι επιθέσεις εξ αποστάσεως των φίλιων μονάδων είναι εγγυημένες να χτυπήσουν για {0} <sprite name=\"time icon\">.",
                    ["fr"] = "Obtenez la commande \"Œil de la Mort\", utilisable une fois. Toutes les attaques à distance des unités alliées sont garanties de toucher pendant {0} <sprite name=\"time icon\">.",
                    ["zh"] = "获得\"死神之眼\"指令，限一次。所有友方单位的远程攻击在 {0} <sprite name=\"time icon\">内必定命中。",
                    ["zh-TW"] = "獲得\"死神之眼\"指令，限一次。所有友方單位的遠程攻擊在 {0} <sprite name=\"time icon\">內必定命中。",
                    ["de"] = "Erhalte den Befehl \"Auge des Todes\", einmal verwendbar. Alle Fernkampfangriffe verbündeter Einheiten treffen garantiert für {0} <sprite name=\"time icon\">.",
                    ["pl"] = "Zdobądź komendę \"Oko Śmierci\", do jednorazowego użycia. Wszystkie ataki dystansowe sojuszniczych jednostek gwarantują trafienie przez {0} <sprite name=\"time icon\">.",
                    ["pt"] = "Ganhe o comando \"Olho da Morte\", utilizável uma vez. Todos os ataques à distância de unidades aliadas acertam garantidamente por {0} <sprite name=\"time icon\">.",
                    ["ru"] = "Получите команду \"Око Смерти\", используется один раз. Все дальние атаки союзных юнитов гарантированно попадают в течение {0} <sprite name=\"time icon\">.",
                    ["es"] = "Obtén el comando \"Ojo de la Muerte\", utilizable una vez. Todos los ataques a distancia de las unidades aliadas están garantizados de impactar durante {0} <sprite name=\"time icon\">.",
                    ["uk"] = "Отримайте команду \"Око Смерті\", використовується один раз. Усі далекі атаки союзних юнітів гарантовано влучають протягом {0} <sprite name=\"time icon\">.",
                    ["ja"] = "\"死神の目\"コマンドを獲得、一度のみ使用可能。すべての味方ユニットの遠距離攻撃が{0} <sprite name=\"time icon\">の間必ず命中する。",
                    ["ko"] = "\"죽음의 눈\" 명령 획득, 한 번만 사용 가능. 모든 아군 유닛의 원거리 공격이 {0} <sprite name=\"time icon\"> 동안 반드시 명중합니다.",
                },
                ...
                {
                    ["en"] = "All friendly units' ranged attacks are guaranteed to hit for {0} <sprite name=\"time icon\">.",
                    ["el"] = "Όλες οι επιθέσεις εξ αποστάσεως των φίλιων μονάδων είναι εγγυημένες να χτυπήσουν για {0} <sprite name=\"time icon\">.",
                    ["fr"] = "Toutes les attaques à distance des unités alliées sont garanties de toucher pendant {0} <sprite name=\"time icon\">.",
                    ["zh"] = "所有友方单位的远程攻击在 {0} <sprite name=\"time icon\">内必定命中。",
                    ["zh-TW"] = "所有友方單位的遠程攻擊在 {0} <sprite name=\"time icon\">內必定命中。",
                    ["de"] = "Alle Fernkampfangriffe verbündeter Einheiten treffen garantiert für {0} <sprite name=\"time icon\">.",
                    ["pl"] = "Wszystkie ataki dystansowe sojuszniczych jednostek gwarantują trafienie przez {0} <sprite name=\"time icon\">.",
                    ["pt"] = "Todos os ataques à distância de unidades aliadas acertam garantidamente por {0} <sprite name=\"time icon\">.",
                    ["ru"] = "Все дальние атаки союзных юнитов гарантированно попадают в течение {0} <sprite name=\"time icon\">.",
                    ["es"] = "Todos los ataques a distancia de las unidades aliadas están garantizados de impactar durante {0} <sprite name=\"time icon\">.",
                    ["uk"] = "Усі далекі атаки союзних юнітів гарантовано влучають протягом {0} <sprite name=\"time icon\">.",
                    ["ja"] = "すべての味方ユニットの遠距離攻撃が{0} <sprite name=\"time icon\">の間必ず命中する。",
                    ["ko"] = "모든 아군 유닛의 원거리 공격이 {0} <sprite name=\"time icon\"> 동안 반드시 명중합니다.",
                },
            };
        }
    }
